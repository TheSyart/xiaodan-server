...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/credits/rules', component: () => import('./views/credits/Rules.vue'), meta: { title: '作业模板' } },
    ...
    { path: '/credits/api', component: () => import('./views/credits/Api.vue'), meta: { title: '开放接口' } },
